...
const config = {
  "generator": {
    ...
    "output": {
      "value": "D:\\workspace\\laube\\laube-admin\\packages\\server\\prisma\\client\\mysql",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "D:\\workspace\\laube\\laube-admin\\packages\\server\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        "fromEnvVar": null,
        "value": "mysql://root:123456@localhost:3306/laube-admin"
      }
    }
  },
  ...
  "inlineSchemaHash": "c4275dc14aeb618b511336b6891e78cbfdb6c90869489bfde97ccb16c2ecc333",
  "copyEngine": true
}
...
path.join(process.cwd(), "prisma/client/mysql/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
