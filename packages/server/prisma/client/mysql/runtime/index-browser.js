...
var Ce = (e, n) => {
  ...
  Ke = (e, n, i, t) => {
    if ((n && typeof n == 'object') || typeof n == 'function')
      for (let r of Ge(n)) !Je.call(e, r) && r !== i && ne(e, r, { get: () => n[r], enumerable: !(t = We(n, r)) || t.enumerable })
    return e
  }
...
h.hyperbolicCosine = h.cosh = function () {
  ...
  ;(i = o.precision),
    ...
    (o.rounding = 1),
    (r = s.d.length),
    r < 32 ? ((e = Math.ceil(r / 3)), (n = (1 / ae(4, e)).toString())) : ((e = 16), (n = '2.3283064365386962890625e-10')),
...
h.logarithm = h.log = function (e) {
  ...
  if (((w = !1), (u = a + g), (o = B(f, u)), (t = n ? fe(l, u + 10) : B(e, u)), (c = k(o, t, u, 1)), Q(c.d, (r = a), d)))
    do
...
h.toFixed = function (e, n) {
  ...
  return (
    e === void 0
      ? (i = L(r))
      : (q(e, 0, H), n === void 0 ? (n = s.rounding) : q(n, 0, 8), (t = p(new s(r), e + r.e + 1, n)), (i = L(t, !1, e + t.e + 1))),
...
h.toPrecision = function (e, n) {
  ...
  return (
    e === void 0
      ...
      : (q(e, 1, H), n === void 0 ? (n = r.rounding) : q(n, 0, 8), (t = p(new r(t), e, n)), (i = L(t, e <= t.e || t.e <= r.toExpNeg, e))),
    t.isNeg() && !t.isZero() ? '-' + i : i
  )
}
h.toSignificantDigits = h.toSD = function (e, n) {
  var i = this,
    t = i.constructor
  return (
    e === void 0 ? ((e = t.precision), (n = t.rounding)) : (q(e, 1, H), n === void 0 ? (n = t.rounding) : q(n, 0, 8)), p(new t(i), e, n)
  )
}
h.toString = function () {
  var e = this,
  ...
  return (
    ...
    t == null
      ...
      : n < 4
        ...
        : (o = (((t || i < 4) && u + 1 == s) || (!t && i > 3 && u + 1 == s / 2)) && ((e[r + 1] / s / 1e3) | 0) == C(10, n - 3) - 1),
    o
  )
}
function re(e, n, i) {
...
function an(e, n) {
  ...
  ;(t = n.d.length),
    t < 32 ? ((i = Math.ceil(t / 3)), (r = (1 / ae(4, i)).toString())) : ((i = 16), (r = '2.3283064365386962890625e-10')),
    (e.precision += i),
...
var k = (function () {
  ...
  return function (t, r, s, o, u, c) {
    ...
    if (
      (S[a] > (O[a] || 0) && l--, s == null ? ((I = s = ee.precision), (o = ee.rounding)) : u ? (I = s + (t.e - r.e) + 1) : (I = s), I < 0)
    )
      _.push(1), (v = !0)
    else {
    ...
    if (
      ...
      (f =
        i < 4
          ...
          : c > 5 ||
            (c == 5 &&
              (i == 4 || t || (i == 6 && (s > 0 ? (o > 0 ? l / C(10, r - o) : 0) : a[d - 1]) % 10 & 1) || i == (e.s < 0 ? 8 : 7)))),
      n < 1 || !a[0])
    )
...
function L(e, n, i) {
  ...
  return (
    n
      ? (i && (t = i - o) > 0 ? (s = s.charAt(0) + '.' + s.slice(1) + U(t)) : o > 1 && (s = s.charAt(0) + '.' + s.slice(1)),
        (s = s + (e.e < 0 ? 'e' : 'e+') + e.e))
      : r < 0
        ? ((s = '0.' + U(-r - 1) + s), i && (t = i - o) > 0 && (s += U(t)))
        : r >= o
          ? ((s += U(r + 1 - o)), i && (t = i - r - 1) > 0 && (s = s + '.' + U(t)))
          : ((t = r + 1) < o && (s = s.slice(0, t) + '.' + s.slice(t)), i && (t = i - o) > 0 && (r + 1 === o && (s += '.'), (s += U(t)))),
    s
  )
}
function le(e, n) {
...
function B(e, n) {
  ...
  for (a = N, c = o = N = k(N.minus(1), N.plus(1), l, 1), d = p(N.times(N), l, 1), r = 3; ; ) {
    if (((o = p(o.times(d), l, 1)), (f = c.plus(k(o, new M(r), l, 1))), b(f.d).slice(0, l) === b(c.d).slice(0, l)))
      if (((c = c.times(2)), s !== 0 && (c = c.plus(fe(M, l + 2, E).times(s + ''))), (c = k(c, new M(g), l, 1)), n == null))
        if (Q(c.d, l - v, _, u))
...
function se(e, n) {
  ...
  for (
    (i = n.indexOf('.')) > -1 && (n = n.replace('.', '')),
      (t = n.search(/e/i)) > 0 ? (i < 0 && (i = t), (i += +n.slice(t + 1)), (n = n.substring(0, t))) : i < 0 && (i = n.length),
      t = 0;
    n.charCodeAt(t) === 48;
    t++
  );
  ...
  if ((v ? (q(i, 1, H), t === void 0 ? (t = g.rounding) : q(t, 0, 8)) : ((i = g.precision), (t = g.rounding)), !e.isFinite())) l = $e(e)
    ...
    for (
      l = L(e),
        ...
        o >= 0 && ((l = l.replace('.', '')), (d = new g(1)), (d.e = l.length - o), (d.d = re(L(d), 10, r)), (d.e = d.d.length)),
        a = re(l, 10, r),
        s = c = a.length;
      a[--c] == 0;
    ...
    if (!a[0]) l = v ? '0p+0' : '0'
      ...
      if (
        (o < 0 ? s-- : ((e = new g(e)), (e.d = a), (e.e = s), (e = k(e, d, i, t, 0, r)), (a = e.d), (s = e.e), (f = Te)),
        (o = a[i]),
        (u = r / 2),
        (f = f || a[i + 1] !== void 0),
        (f =
...
function Pn(e) {
  ...
  var n,
    ...
    t,
    r = e.defaults === !0,
    s = ['precision', 1, H, 'rounding', 0, 8, 'toExpNeg', -V, 0, 'toExpPos', 0, V, 'maxE', 0, V, 'minE', -V, 0, 'modulo', 0, 9]
